...
const AddBook = () => {
    ...
    const handleSubmit = (event) => {
        ...
        axios({
            method: 'post',
            url: 'https://localhost:4200/api/books',
        ...
        <div className="container">
            ...
            <Form onSubmit={handleSubmit}>
                <Form.Group controlId="name">
                    ...
                    <Form.Control onBlur={handleOnBlur} type="text" placeholder="Enter Plant Name" required/>
                </Form.Group>
                <Form.Group controlId="author">
                    <Form.Label>Plant Type</Form.Label>
                    <Form.Control onBlur={handleOnBlur} type="text" placeholder="Enter Plant Type" required/>
                </Form.Group>
                <Form.Group controlId="price">
                    <Form.Label>Plant Price</Form.Label>
                    <Form.Control onBlur={handleOnBlur} type="text" placeholder="Enter Plant Price" required/>
                </Form.Group>
                <Form.Group controlId="image">
                    <Form.File.Label>Plant Image Upload</Form.File.Label>
